...
try:
    logs_root_directory = r"Y:\logs-nc01"
...
log_file = os.path.join(log_dir, "NC01_3_months_old_logs_zip_history.log")
...
def zip_monthly_files(monthly_files, base_path, subdirectory=None):
    ...
    for year_month, files in tqdm(monthly_files.items(), desc="Creating monthly archives"):
